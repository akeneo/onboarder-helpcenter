...
# Assets
When you assign a product to a supplier, all the assets linked to this product will be sent. The supplier will be able to pick in the asset collection linked to the products or to upload new media files for a product.

:::warning
Only media files of an assets linked to the asset collection of a product are synchronized with the Onboarder.
:::
